...
public class _opaque_pthread_t {
    ...
    static final VarHandle __cleanup_stack$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("__cleanup_stack"));
    ...
    public static MemoryAddress __cleanup_stack$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_opaque_pthread_t.__cleanup_stack$VH.get(seg);
    }
    ...
    public static MemoryAddress __cleanup_stack$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_opaque_pthread_t.__cleanup_stack$VH.get(seg.asSlice(index*sizeof()));
    }
