...
public class __siginfo {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(7, Constants$root.C_LONG_LONG$LAYOUT).withName("__pad")
    ).withName("__siginfo");
    ...
    static final VarHandle si_pid$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("si_pid"));
    ...
    static final VarHandle si_uid$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("si_uid"));
    ...
    static final VarHandle si_status$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("si_status"));
    ...
    static final VarHandle si_addr$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("si_addr"));
    public static VarHandle si_addr$VH() {
        return __siginfo.si_addr$VH;
    }
    public static MemoryAddress si_addr$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)__siginfo.si_addr$VH.get(seg);
    }
    ...
    public static MemoryAddress si_addr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)__siginfo.si_addr$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle si_band$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("si_band"));
