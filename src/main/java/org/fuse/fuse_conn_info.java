...
public class fuse_conn_info {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.structLayout(
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(1).withName("case_insensitive"),
                MemoryLayout.paddingLayout(1).withName("setvolname"),
                MemoryLayout.paddingLayout(1).withName("xtimes"),
    ...
    public static class enable {
        ...
        static final  GroupLayout enable$struct$LAYOUT = MemoryLayout.structLayout(
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(1).withName("case_insensitive"),
                MemoryLayout.paddingLayout(1).withName("setvolname"),
                MemoryLayout.paddingLayout(1).withName("xtimes"),
        ...
        public static MemoryLayout $LAYOUT() {
            return enable.enable$struct$LAYOUT;
        }
