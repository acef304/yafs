...
public class _opaque_pthread_rwlockattr_t {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(16, Constants$root.C_CHAR$LAYOUT).withName("__opaque")
    ).withName("_opaque_pthread_rwlockattr_t");
    public static MemoryLayout $LAYOUT() {
        return _opaque_pthread_rwlockattr_t.$struct$LAYOUT;
    }
    ...
    public static VarHandle __sig$VH() {
        return _opaque_pthread_rwlockattr_t.__sig$VH;
    }
    public static long __sig$get(MemorySegment seg) {
        return (long)_opaque_pthread_rwlockattr_t.__sig$VH.get(seg);
    }
    public static void __sig$set( MemorySegment seg, long x) {
        _opaque_pthread_rwlockattr_t.__sig$VH.set(seg, x);
    }
    public static long __sig$get(MemorySegment seg, long index) {
        return (long)_opaque_pthread_rwlockattr_t.__sig$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __sig$set(MemorySegment seg, long index, long x) {
        _opaque_pthread_rwlockattr_t.__sig$VH.set(seg.asSlice(index*sizeof()), x);
    }
