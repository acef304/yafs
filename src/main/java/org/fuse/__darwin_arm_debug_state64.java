...
public class __darwin_arm_debug_state64 {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, Constants$root.C_LONG_LONG$LAYOUT).withName("__bvr"),
        MemoryLayout.sequenceLayout(16, Constants$root.C_LONG_LONG$LAYOUT).withName("__bcr"),
        MemoryLayout.sequenceLayout(16, Constants$root.C_LONG_LONG$LAYOUT).withName("__wvr"),
        MemoryLayout.sequenceLayout(16, Constants$root.C_LONG_LONG$LAYOUT).withName("__wcr"),
        Constants$root.C_LONG_LONG$LAYOUT.withName("__mdscr_el1")
    ).withName("__darwin_arm_debug_state64");
    public static MemoryLayout $LAYOUT() {
        return __darwin_arm_debug_state64.$struct$LAYOUT;
    }
    ...
    public static VarHandle __mdscr_el1$VH() {
        return __darwin_arm_debug_state64.__mdscr_el1$VH;
    }
    public static long __mdscr_el1$get(MemorySegment seg) {
        return (long)__darwin_arm_debug_state64.__mdscr_el1$VH.get(seg);
    }
    public static void __mdscr_el1$set( MemorySegment seg, long x) {
        __darwin_arm_debug_state64.__mdscr_el1$VH.set(seg, x);
    }
    public static long __mdscr_el1$get(MemorySegment seg, long index) {
        return (long)__darwin_arm_debug_state64.__mdscr_el1$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void __mdscr_el1$set(MemorySegment seg, long index, long x) {
        __darwin_arm_debug_state64.__mdscr_el1$VH.set(seg.asSlice(index*sizeof()), x);
    }
